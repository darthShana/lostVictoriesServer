...
public class LostVictoriesServiceImpl extends LostVictoriesServerGrpc.LostVictoriesServerImplBase {
    ...
    public LostVictoriesServiceImpl(JedisPool jedisPool, String instance, GameRequestDAO gameRequestDAO, PlayerUsageDAO playerUsageDAO, MessageRepository messageRepository, WorldRunner worldRunner) {
        lostVictoriesService = new LostVictoriesService(jedisPool, instance, gameRequestDAO, playerUsageDAO, messageRepository, worldRunner);
    }
