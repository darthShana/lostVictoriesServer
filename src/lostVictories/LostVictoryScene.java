...
public class LostVictoryScene {
	...
	public void loadScene(CharacterDAO characterDAO, HouseDAO housesDAO) throws JsonGenerationException, JsonMappingException, IOException {
		...
		Vector germanBase = new Vector(-125, 7, 370);
		Vector americanBase = new Vector(195, 7, -375);
		...
		CharacterMessage a1 = new CharacterMessage(UUID.fromString("2fbe421f-f701-49c9-a0d4-abb0fa904204"), CharacterType.AVATAR, germanBase.add(-85, 0, 10), Country.GERMAN, Weapon.RIFLE, RankMessage.CADET_CORPORAL, gl1.getId(), false);
		loadSquad(characters, a1, germanBase.add(-90, 0, 15), Country.GERMAN, true, Weapon.RIFLE, Weapon.RIFLE, Weapon.RIFLE);
		a1.addObjective(UUID.randomUUID(), createBootCampObjective(germanBase.add(-100, 0, -65)));
...
//		a1.incrementKills(UUID.randomUUID());
		...
		CharacterMessage a2 = new CharacterMessage(UUID.randomUUID(), CharacterType.SOLDIER, germanBase.add(-105, 0, 10), Country.GERMAN, Weapon.RIFLE, RankMessage.CADET_CORPORAL, gl1.getId(), false);
        loadSquad(characters, a2, germanBase.add(-110, 0, 15), Country.GERMAN, Weapon.RIFLE, Weapon.RIFLE, Weapon.MG42);
        ...
        loadSquad(characters, a3, germanBase.add(-120, 7, 15), Country.GERMAN, Weapon.RIFLE, Weapon.RIFLE, Weapon.RIFLE);
        ...
        loadSquad(characters, a4, germanBase.add(-140, 7, 15), Country.GERMAN, Weapon.RIFLE, Weapon.RIFLE, Weapon.MORTAR);
